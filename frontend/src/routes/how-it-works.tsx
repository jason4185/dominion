  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "How it works — DOMINION" },
      {
        ...
        content:
          "Pari-mutuel hourly stock dominance markets, settled by exchange source consensus.",
      },
    ],
  }),
...
const FAQ = [
  {
    q: "Can I bet on two assets in the same market?",
    a: "No. One wallet backs exactly one asset per market. Top-ups on that same asset are always allowed while betting is open.",
  },
  {
    q: "What is my payout?",
    a: "Your share of the winning pool multiplied by the total market pool. Since the fee is 0%, the entire pool is distributed to winners.",
  },
  {
    q: "What happens if two assets tie?",
    a: "Ties are resolved by source consensus. If two or more sources cannot agree on a single winner, the market resolves inconclusive and all stakes are refundable.",
  },
  {
    q: "What if all three stocks fall?",
    a: "The least-negative return wins. Dominance is relative, not absolute.",
  },
  {
    q: "Who can settle a market?",
    a: "Any wallet. Settlement is permissionless once the window has expired and reference candles are available.",
  },
  {
    q: "Is there a maximum bet?",
    a: "No app-level maximum. Your wallet balance is the only limit.",
  },
];
